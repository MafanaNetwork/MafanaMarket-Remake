...
public class MarketShop_GUI implements Listener {
    ...
    public PaginatedGui getMarketShopGui(ItemType itemType) {
        PaginatedGui gui = Gui.paginated()
                .title(Component.text(ChatColor.GOLD + "MafanaMarket " + ChatColor.DARK_GREEN + itemType.getLore() + ChatColor.GOLD + " Rentables"))
                .rows(6)
                .pageSize(28)
        ...
        for (MarketRenting listing : MafanaMarketRentables.getInstance().getListingData().getAllListings()) {
            if (itemType == ItemType.ARMOR) {
                ...
                || new NBTItem(listing.getItem()).getString("ItemType").equalsIgnoreCase(ItemType.HELMET.getLore()) || new NBTItem(listing.getItem()).getString("ItemType").equalsIgnoreCase(ItemType.BOOTS.getLore())) {
                    ...
                    itemLore.add(ChatColor.DARK_GRAY + "Days: " + listing.getDays());
    ...
    public PaginatedGui getMarketShopGui(ItemType itemType, String s) {
        PaginatedGui gui = Gui.paginated()
                .title(Component.text(ChatColor.GOLD + "MafanaMarket " + ChatColor.DARK_GREEN + itemType.getLore() + ChatColor.GOLD + " Rentables " + ChatColor.GRAY + "Filter: " + s))
                .rows(6)
                .pageSize(28)
                .disableAllInteractions()
                .create();
    ...
    public PaginatedGui getMarketShopGui() {
        PaginatedGui gui = Gui.paginated()
                .title(Component.text(ChatColor.GOLD + "MafanaMarket All Rentables"))
                .rows(6)
                .pageSize(28)
                .disableAllInteractions()
                .create();
    ...
    public PaginatedGui getMarketShopGui(String s) {
        PaginatedGui gui = Gui.paginated()
                .title(Component.text(ChatColor.GOLD + "MafanaMarket All Rentables " + ChatColor.GRAY + "Filter: " + s))
                .rows(6)
                .pageSize(28)
                .disableAllInteractions()
                .create();
